...
The measured package attribution and profile-based ASR comparison inform the [post-release roadmap](../../project/roadmap.md). They remain design work until native-Windows packaging, recovery, privacy, and repeat-start acceptance tests pass.
